...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    public JwtAuthenticationFilter(JwtService jwtService, UsuarioSecurityService usuarioSecurityService) {
    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            if (email != null && SecurityContextHolder.getContext().getAuthentication() == null) {
                UserDetails userDetails = usuarioSecurityService.loadUserByUsername(email);
